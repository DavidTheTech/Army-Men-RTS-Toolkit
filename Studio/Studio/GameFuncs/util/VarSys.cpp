...
typedef int(__fastcall* VarSysCreateString_t)(const char* path, const char* value, int flags, void* varStringPtr, void* context);
...
typedef void(__thiscall* VarSys_SetString_t)(void* varPtr, const char* strValue);
...
static VarSys_SetString_t SetString_Fn = (VarSys_SetString_t)(Memory::ScanAddress(0x4E0120));
...
int VarSys::CreateString(const char* name, const char* value, int flagsIn, void* varPtr, void* context)
{
